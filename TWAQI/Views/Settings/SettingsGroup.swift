...
struct SettingsGroup_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            SettingsGroup(stationGroup: StationGroup(name: "Lianjiang County", localName: "連江縣", stations: [
                Station(name: "Lianjiang", localName: "馬祖", lon: 119.949875, lat: 26.160469)
            ]))
            SettingsGroup(stationGroup: StationGroup(name: "Taipei City", localName: "臺北市", stations: [
